...
if __name__ == '__main__':
    ...
    # Iterates over all instances and solves them via CP-DWD with the CP-LNS primal heuristic phase disabled
    ...
    for file in sorted(dir_path.glob("*.json")):
        try:
            ...
            # Solve instance via CP-DWD, skipping CP-LNS
            hsf_p = Hybrid_Solver(instance=instance)
            hsf_p.CP_DWD(TimeLimit=time_limit, DisableLNS=True)
