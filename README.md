...
- `scripts/`: the experiment drivers that solve instances via CP-DWD (`main.py`) and via the monolithic CP and IP baselines (`monolithic_baseline.py`).
